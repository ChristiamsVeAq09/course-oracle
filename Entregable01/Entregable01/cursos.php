...
<h1>Cursos de Alumno</h1>
<a href="views/registro_cursos.php" class="btn btn-success">Agregar Nuevo</a>
<?php
    include 'db/db.php';
    ...
    <?php
        while($row_curso = mysqli_fetch_assoc($result_cursos)){
            echo "
                <tr>
                    <td>$row_curso[id]</td>
                    <td>$row_curso[nombre]</td>
                    <td>$row_curso[apellido]</td>
                    <td>$row_curso[curso]</td>
                    <td>$row_curso[Duracion_semanas]</td>
                    <td><a href='views/editar_cursos.php?id=$row_curso[id]' class='btn btn-warning'><img src='icons/pencil-solid.svg'></a></td>
                    <td><button class='btn btn-danger open-modal' data-id=$row_curso[id] data-bs-toggle='modal' 
